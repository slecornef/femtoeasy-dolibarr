...
/**
 *	  \file	   htdocs/factory/admin/factory_extrafields.php
 *		\ingroup	factory
 *		\brief	  Page to setup extra fields of factory
 */
...
$page_name = $langs->trans('FactorySetup') ." - ". $langs->trans("Extrafields");
...
dol_fiche_head($head, 'attributes', $tab, -1, 'factory@factory');
